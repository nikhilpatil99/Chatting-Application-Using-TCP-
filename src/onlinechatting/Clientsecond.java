 ...
 * @author admin
 */
public class Clientsecond extends javax.swing.JFrame {

    /**
     * Creates new form Clientsecond
     */
    public Clientsecond() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        area18 = new javax.swing.JTextArea();
        jLabel15 = new javax.swing.JLabel();
        jLabel16 = new javax.swing.JLabel();
        ipa5 = new javax.swing.JTextField();
        jLabel17 = new javax.swing.JLabel();
        jScrollPane8 = new javax.swing.JScrollPane();
        area16 = new javax.swing.JTextArea();
        ...
        area18.setColumns(20);
        area18.setRows(5);
        jScrollPane7.setViewportView(area18);

        jLabel15.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Reply From Another Client");
        ...
        jLabel17.setText("Enter the Message");

        area16.setColumns(20);
        area16.setRows(5);
        jScrollPane8.setViewportView(area16);
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addComponent(port5, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addComponent(jLabel16, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(ipa5, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ipa5, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(4, 4, 4)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(port5, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try{
            ...
            String ip= ipa5.getText();
            int p=Integer.parseInt(port5.getText());
            InetAddress ina = InetAddress.getByName(ip);
              Socket s=new Socket(ina,p);
                       
                       InputStream in = s.getInputStream();
                       OutputStream out = s.getOutputStream();
                       System.out.println("2 Client Created");
                       int k=18;
                       ...
                       String r=decrypt(s1, k);
                       area18.setText(r);
                       JOptionPane.showMessageDialog(null,"Message Recived");
                        byte[] buff1= new byte[513];
                       
                       String s2=area16.getText();
                       String r1=encrypt(s2, k);
                       buff1=r1.getBytes();
                       out.write(buff1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Clientsecond.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextArea area16;
    private javax.swing.JTextArea area18;
